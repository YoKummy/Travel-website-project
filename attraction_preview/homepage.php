    ...
    <?php endif; ?>
        ...
        <div class="body_container">
            <div class ="Header">
                ...
                <div class="wrapper">
                    <div class="content">
                    <ul><input type="search" spellcheck="false" placeholder="Press enter or add a comma after each tag" data-search></ul>
                    </div>
                    <div class="details">
                ...
                <button id="toggle-btn" onclick="togglePages()">切換至行程</button>
